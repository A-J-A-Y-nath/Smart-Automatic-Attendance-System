...
public class StudentDashboardActivity extends AppCompatActivity {
        ...
        ApiClient.getInstance(this).getActiveSession(new ApiClient.ApiCallback() {
            ...
            public void onSuccess(JSONObject response) {
                ...
                if (session != null) {
                    ...
                    // Capture both SSID and BSSID from active-session response
                    currentTargetSsid = session.optString("target_ssid", "");
                    currentTargetBssid = session.optString("target_bssid", "");
    ...
    private void startScanning() {
        ...
        if (currentSessionId == -1) {
            Toast.makeText(
                this,
                "No active class session currently. Please ask your teacher to start attendance!",
                Toast.LENGTH_LONG
            ).show();
        ...
        // 1. Check for runtime location permission
        // Required by Android for Wi-Fi scanning
        ...
        if (wifiManager == null || !wifiManager.isWifiEnabled()) {
            ...
            Toast.makeText(
                this,
                "Please turn ON Wi-Fi in Quick Settings to scan for beacon.",
                Toast.LENGTH_LONG
            ).show();
        ...
        // 3. Check if Location Services (GPS) is enabled
        ...
        if (!isLocationEnabled) {
            ...
            Toast.makeText(
                this,
                "Android requires Location (GPS) ON to detect Wi-Fi beacons.",
                Toast.LENGTH_LONG
            ).show();
        ...
        wifiScanner.startScan(
            ...
            new WifiScanner.ScanCallback() {
                ...
                public void onBeaconFound(
                    ...
                    markAttendance(ssid, bssid, rssi);
                }
                ...
                public void onScanFailed() {
                    ...
                    tvStatus.setText(
                        "Scan failed. Ensure Wi-Fi & Location (GPS) are ON."
                    );

                    Toast.makeText(
                        StudentDashboardActivity.this,
                        "Scan failed. Ensure Wi-Fi & Location are enabled.",
                        Toast.LENGTH_LONG
                    ).show();
                }
                ...
                public void onScanFinished() {
                    ...
                    Toast.makeText(
                        StudentDashboardActivity.this,
                        "Classroom Wi-Fi beacon not detected near you (Status: Absent).",
                        Toast.LENGTH_LONG
                    ).show();
                }
            }
    ...
    public void onRequestPermissionsResult(
        ...
        if (requestCode == PERMISSION_REQUEST_CODE) {
            if (grantResults.length > 0 &&
                ...
                Toast.makeText(
                    this,
                    "Location permission is required to scan Wi-Fi beacons.",
                    Toast.LENGTH_LONG
                ).show();
            }
        }
            ...
            new ApiClient.ApiCallback() {
                ...
                public void onSuccess(JSONObject response) {
                    ...
                    boolean alreadyMarked =
                        response.optBoolean("already_marked", false);
                    ...
                    if (!success) {
                        ...
                        Toast.makeText(
                            StudentDashboardActivity.this,
                            "Already Marked: Attendance was already recorded for this period!",
                            Toast.LENGTH_LONG
                        ).show();
    ...
    private void fetchMyStats() {
        ...
        android.widget.LinearLayout container =
            findViewById(R.id.subjectStatsContainer);
        TextView tvPlaceholder =
            findViewById(R.id.tvStatsPlaceholder);

        if (tvOverallPercent == null || container == null) return;

        ApiClient.getInstance(this).adminGet(
            "/api/student/my-stats",
            new ApiClient.ApiCallback() {
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        tvTotalPresent.setText(
                            String.valueOf(totalP)
                        );

                        tvTotalAbsent.setText(
                        ...
                        progressOverall.setProgress(
                            (int) Math.round(overallPct)
                        );

                        org.json.JSONArray subjects =
                            response.optJSONArray("subjects");
